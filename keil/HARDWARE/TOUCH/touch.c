...
//提示字符串
const char* TP_REMIND_MSG_TBL="Touch calibration start !";
...
{								 
	...
	LCD_Clear(WHITE);//清屏 	   
	POINT_COLOR=BLACK;
	LCD_ShowString(20,40,200,100,16,(u8*)TP_REMIND_MSG_TBL);//显示提示信息
